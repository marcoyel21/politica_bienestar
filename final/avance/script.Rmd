...
#ahora triangular.
out = rdrobust(cambio_esp_top, cambio_internet, kernel = "triangular", p = 4, c=20,h = 5)
summary(out)
...
out = rdbwselect(cambio_esp_top, cambio_internet, kernel = "triangular", p = 4, bwselect = "mserd")
summary(out)

#main bandwidth - 4.273

out = rdbwselect(cambio_esp_top, cambio_internet,c=20, kernel = "triangular", p = 4, bwselect = "mserd")
summary(out)
...
out = rdrobust(cambio_esp_top, cambio_internet,c=20, kernel = "triangular", p = 4, bwselect = "mserd")
