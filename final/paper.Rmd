...
stargazer(dat,digits=2,type='latex',title="Tabla 1. Resumen estadisticas descriptivas",covariate.labels =c("Cambio Top Espanol","Cambio Top Mate","Cambio Bottom Español","Cambio Bottom Mate","Cambio Internet","Promedio Escolaridad","Marginacion","Pob. Ocupada","Pob. Lengua indígena","Electricidad","Niñas estudiando"))
```
...
En cuanto a los puntos de corte iniciales, estos se elijieron graficamente de tal manera que se maximizara la diferencia de medias entre ambos grupos. Si bien, para algunas variables fue trivial, para otras simplemente no se encontro ningún punto optimo posible, probablemente debido a que no existe una discontinuidad o a que esta es muy débil.
