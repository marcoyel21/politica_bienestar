...
```
Con esta variable definitoria, solo observamos resultados significativos en el cambio de la proporción de alumnos que pasan a ser del nivel de logro más alto en Español, con un estimador del efecto de tratamiento local (LATE) de 1.234 y un nivel de significancia de 0.03. 

La interpretación de este resultado es que 
...
```{r, echo=FALSE,message=FALSE,warning=FALSE,header=FALSE}
out = rdplot(data$cambio_esp_top,data$cambio_internet,kernel = "triangular", c=9,p = 1,x.lim=c(5,13),y.lim=c(0,7.5))

```

```{r, echo=FALSE,message=FALSE,warning=FALSE,header=FALSE}
out1 = rdplot(data$cambio_mat_top,data$cambio_internet,kernel = "triangular", y.lim=c(0,7.5),x.lim=c(12.3,28.7),c=21,p = 1)

```

```{r, echo=FALSE,message=FALSE,warning=FALSE,header=FALSE}
out2 = rdplot(data$cambio_mat_bottom,data$cambio_internet,kernel = "triangular", c=3,p = 1)

```


```{r, echo=FALSE,message=FALSE,warning=FALSE,header=FALSE, include=FALSE}
out3 = rdplot(data$cambio_mat_bottom,data$cambio_internet,kernel = "triangular", c=6,p = 1, x.lim=c(3.17,10.84))

```

```{r, echo=FALSE,message=FALSE,warning=FALSE,header=FALSE}
out4 = rdplot(data$cambio_esp_top,data$inter_pc_internet,kernel = "triangular", c=9,p = 1,x.lim=c(-28.304,46.304),y.lim=c(0,7.5))

```


```{r, echo=FALSE,message=FALSE,warning=FALSE,header=FALSE}
out5 = rdplot(data$cambio_mat_top,data$inter_pc_internet, kernel = "triangular", c=17,p = 1,x.lim=c(-18.984,52.984),y.lim=c(0,7.5))

```

```{r, echo=FALSE,message=FALSE,warning=FALSE,header=FALSE, include=FALSE}
out6 = rdplot(data$cambio_esp_bottom,data$inter_pc_internet,kernel = "triangular", c=3,p = 1, x.lim=c(-35.146,41.146),y.lim=c(0,7.5))

```

```{r, echo=FALSE,message=FALSE,warning=FALSE,header=FALSE, include=FALSE}
out7 = rdplot(data$cambio_mat_bottom,data$inter_pc_internet,kernel = "triangular", c=17,p = 1,x.lim=c(-24.53,58.53),y.lim=c(0,7.5))
