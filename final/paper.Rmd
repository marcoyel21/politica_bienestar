...
Las covariables que se incorporarán al modelo serán del 2020:

•	$Marg_i$: el nivel de marginación de la localidad i.
•	$Escolar_i$: el grado promedio de escolaridad en la localidad i en el año t.
•	$PEA_i$: el porcentaje de la población económicamente activa en la localidad i en el año t.
•	$_i$: INDIG
•	$niñas$: 
•	$electricidad$: 
...
kable(dataf, booktabs=T,col.names=c("X", "Top", "Bottom",
...
```{r, echo=FALSE,message=FALSE,warning=FALSE,header=FALSE, include=FALSE}
out1 = rdrobust(data$cambio_mat_top,data$cambio_internet,covs=Z, kernel = "triangular", c=21,p = 1, bwselect = "mserd",cluster=data$ClaveMun)
```

```{r, echo=FALSE,message=FALSE,warning=FALSE,header=FALSE, include=FALSE}
out2 = rdrobust(data$cambio_esp_bottom,data$cambio_internet,covs=Z, kernel = "triangular", c=3,p = 1, bwselect = "mserd",cluster=data$ClaveMun)
```
```{r, echo=FALSE,message=FALSE,warning=FALSE,header=FALSE, include=FALSE}
out3 = rdrobust(data$cambio_mat_bottom,data$cambio_internet,covs=Z, kernel = "triangular", c=6,p = 1, bwselect = "mserd",cluster=data$ClaveMun)
```
```{r, echo=FALSE,message=FALSE,warning=FALSE,header=FALSE, include=FALSE}
out4 = rdrobust(data$cambio_esp_top,data$inter_pc_internet,covs=Z, kernel = "triangular", c=9,p = 1, bwselect = "mserd",cluster=data$ClaveMun)
```

```{r, echo=FALSE,message=FALSE,warning=FALSE,header=FALSE, include=FALSE}
out5 = rdrobust(data$cambio_mat_top,data$inter_pc_internet,covs=Z, kernel = "triangular", c=17,p = 1, bwselect = "mserd",cluster=data$ClaveMun)
```
```{r, echo=FALSE,message=FALSE,warning=FALSE,header=FALSE, include=FALSE}
out6 = rdrobust(data$cambio_esp_bottom,data$inter_pc_internet,covs=Z, kernel = "triangular", c=3,p = 1, bwselect = "mserd",cluster=data$ClaveMun)
```

```{r, echo=FALSE,message=FALSE,warning=FALSE,header=FALSE, include=FALSE}
out6 = rdrobust(data$cambio_mat_bottom,data$inter_pc_internet,covs=Z, kernel = "triangular", c=17,p = 1, bwselect = "mserd",cluster=data$ClaveMun)
```
...
pval<-c("21","17")
ci<-c("6","17")
dataf<-data.frame(Row,bw,pointe,pval,ci, stringsAsFactors=TRUE)

kable(dataf, booktabs=T,col.names=c("Modelo", "Ancho de banda", "Estimador puntual",
                                    "Valor-p","IC",caption = "Resultados")) %>% 
