...
stargazer(dat,digits=2,type='text',covariate.labels =c("Cambio Espanol","Cambio Mate","Tratamiento","Prom. Escol.",
...
Ahora vemos como cambian nuestras dispersiones al incorporar el ancho de banda adecuado:
