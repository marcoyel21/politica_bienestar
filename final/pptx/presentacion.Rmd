...
* La reforma impacto positivamente al nivel de competitividad del sector, reflejado en una disminucion de los precios de telefonia, aumento de la cobertura, y mejora de calidad del servicio. Esto provocaria una mayor demanda por servicios de Internet en los hogares. 
...
* Convirtio al acceso a Internet en un derecho constitucional. 
...
## Metodologia: Regresión discontinua
...
* Se utilizaron las bases:
    * *Principales resultados por Localidad (ITER)* de la INEGI de los anios 2010 y 2020, 
...
* Las unidades de analisis seran las localidades.
...
* Realizamos un ajuste polinomial global (linea) y obtuvimos las medias muestrales locales de la distribucion (puntos). 
...
---
## Eleccion de ancho de banda

* Posteriormente, verificamos cual es el ancho de banda ideal, *h*. Este controla el ancho de la vecindad alrededor del punto de corte, $c_i$. 

* Su eleccion es fundamental ya que esta afecta a la forma funcional y la obtencion de los estimadores para calcular el ATE.

* El ancho de banda optima con una funcion kernel de tipo triangular, un punto de corte de 9, y orden del polinomio de 1 es de: 
    
    * 4.572 para las calificaciones de espanol
    
    * 4.183 para las de matematicas
...
* Para incluir a las covariables en nuestra estimacion, debemos verificar que no sean distintas en el grupo de tratamiento y de control en el punto de corte. 

* En caso de que fueran distintas, no se cumpliria el supuesto de continuidad, por lo que se tendrian que imponer restricciones adicionales. 
...
Dado que las covariables no estan balanceadas dentro del punto de corte y el ancho del intervalo (5,13], no las incluiremos en la estimacion. 
...
El resultado del coeficiente de $\beta_3$, o el efecto de tratamiento local es de 1.188 en espanol con una significancia de 0.03, y el de matematicas de -0.92 con una significancia de 0.94.
...
La interpretacion es que, dentro del intervalo de cambio en internet (5,13] , el cambio de las calificaciones en espanol promedio de las localidades rurales aumenta en 1.188 puntos porcentuales por tener acceso a Internet. 

Este coeficiente representa a la diferencia en los puntajes en espanol de las localidades que tienen acceso a Internet *apenas por encima* del punto de corte, que es de un cambio en el puntaje de 4.12 pp, menos el de las localidades que *apenas* estan por debajo del punto de corte, que es de 2.93 pp.
