...
* El impacto de la Reforma en Telecomunicaciones del 2013 en México en el desempeño escolar, mediante un aumento en el acceso a Internet de localidades rurales.
...
* Las unidades de analisis serán las localidades.
...
* Su eleccion es fundamental ya que ésta afecta a la forma funcional y la obtención de los estimadores para calcular el ATE.
...
La interpretación es que, dentro del intervalo de cambio en internet (5,13], el cambio de las calificaciones en español promedio de las localidades rurales aumenta en 1.188 puntos porcentuales por tener acceso a Internet. 
...
## Resultados. ####Relación de hallazgos del estudio con los de la bibliografía. 
...
A partir de la revisión de la literatura, se observa que existen autores que detectaron un efecto positivo de la cobertura de Internet en el desempeño de los estudiantes, aunque no muy grande, pero otros no encuentran efecto alguno. 
