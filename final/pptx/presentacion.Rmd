...
La base original consiste en 13,789 observaciones. Al restringir a la muestra a localidades rurales (con poblacion menor a 2,500 habitantes) que hayan participado en ambas evaluaciones (Enlace en 2010 y Planea en 2019), el numero de observaciones se reduce a 3536 observaciones. 
...
out6<- rdplot(cambio_esp_top,cambio_internet,nbins=c(20,20),x.lim=c(-50,50),x.label="Cambio Internet",y.label="Cambio Espanol",title="",kernel="triangular",c=15, binselect = "qspr")
```

```{r, echo=FALSE,message=FALSE,warning=FALSE,header=FALSE}

out7<- rdplot(cambio_mat_top,cambio_internet,nbins=c(20,20),x.lim=c(-50,50),y.lim=c(-10,20),x.label="Cambio Internet",y.label="Cambio Espanol",title="",c=15,kernel="triangular", binselect = "qspr")
```
---
...
```{r, echo=FALSE,message=FALSE,warning=FALSE,header=FALSE}
out6<- rdplot(cambio_mat_top,cambio_internet,nbins=c(20,20),x.lim=c(-25,50),y.lim=c(0,10),x.label="Cambio Internet",y.label="Cambio Espanol",title="",c=15,kernel = "triangular",h=12,binselect = "qspr")
```
