...
#stargazer(dat,digits=2,type='latex',title="Tabla 1. Resumen estadisticas descriptivas",covariate.labels =c("Cambio Espanol","Cambio Mate","Tratamiento","Prom. Escol.","Marginacion","Pob. Ocupada"))
```
...
out6<- rdplot(cambio_esp_top,cambio_internet,nbins=c(20,20),x.lim=c(-50,50),x.label="Cambio Internet",y.label="Cambio Espanol",title="",kernel="triangular",c=10, binselect = "qspr")
```
...
out<-rdplot(data$cambio_esp_top,data$cambio_internet,nbins=c(20,20), kernel = "triangular",c=15,h=19.687 , binselect = "qspr")
```

---

```{r, echo=FALSE,message=FALSE,warning=FALSE,header=FALSE}
out6<- rdplot(cambio_mat_top,cambio_internet,nbins=c(20,20),x.lim=c(-25,50),y.lim=c(0,10),x.label="Cambio Internet",y.label="Cambio Espanol",title="",c=15,kernel = "triangular",h=10.262 ,binselect = "qspr")
```
