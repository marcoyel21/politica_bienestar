...
names<-c('VIVTOT','TVIVPAR','VIVPAR_HAB', #localidad
         'VPH_INTER','VPH_PC','PHOG_IND','P15YM_SE','POBTOT','HOGJEF_F','VPH_CEL') #internet y laptop
for (i in names){
...
censo_20_localidad<-censo %>% 
  select(ENTIDAD,MUN,LOC,       #claves numéricas de localidad
         ...
         VPH_INTER,VPH_PC,PHOG_IND,P15YM_SE,GRAPROES,POCUPADA,PSINDER,TOTHOG,HOGJEF_F,POBTOT,VPH_CEL)   %>%    # internet y laptop       #EN ESTE SELECT AGREGAMOS LAS VARIABLES QUE NECESITEMOS
  mutate(internet_20=VPH_INTER*100/VIVPAR_HAB,
         pc_20=VPH_PC*100/VIVPAR_HAB,
         ...
         jefmujer_20=HOGJEF_F*100/VIVPAR_HAB,
         cel_20=VPH_CEL*100/VIVPAR_HAB
         )
...
planea_localidad_19<-planea_19 %>% 
  ...
  mutate(top_50_esp_19=esp_1II_19+esp_IV_19,
         top_50_mat_19=mat_1II_19+mat_IV_19,
         top_25_esp_19=esp_IV_19,
         top_25_mat_19=mat_IV_19,
         bottom_50_esp_19=esp_1_19+esp_II_19,
         bottom_50_mat_19=mat_1_19+mat_II_19, #convierto a mi variable de interes (porcentaje de niños en la mejor mitad y mitad inferior)
         bottom_25_esp_19=esp_1_19,
         bottom_25_mat_19=mat_1_19) #convierto a mi variable de interes (solo los de hasta abaj)
...
names(planea_localidad_19)[names(planea_localidad_19) == "...10"] <- "GRAD_MARG"
...
planea_localidad_15<-planea_15 %>% 
  select(ENT,`NOMBRE DEL MUNICIPIO`,`NOMBRE DE LA LOCALIDAD`,                  # son entidad, municipio y loc
         ...
         ...40,...41,...42,...43, 
         `GRADO DE MARGINACIÓN`)   %>% # son % de calis de mate y grado marg
  ...
  mutate(top_50_esp_15=esp_1II_15+esp_IV_15,
         top_50_mat_15=mat_1II_15+mat_IV_15,
         top_25_esp_15=esp_IV_15,
         top_25_mat_15=mat_IV_15,
         bottom_50_esp_15=esp_1_15+esp_II_15,
         bottom_50_mat_15=mat_1_15+mat_II_15, #convierto a mi variable de interes (porcentaje de niños en la mejor mitad y mitad inferior)
         bottom_25_esp_15=esp_1_15,
         bottom_25_mat_15=mat_1_15) #convierto a mi variable de interes (solo los de hasta abaj)
...
names(planea_localidad_15)[names(planea_localidad_15) == "GRADO DE MARGINACIÓN "] <- "GRAD_MARG"
...
planea_localidad_10<-planea_10 %>% 
  ...
  summarize(esp_1_10 = mean(POR_N1_ESP_3), 
         ...
         top_50_mat_10=mat_1II_10+mat_IV_10,
         top_50_esp_10=esp_1II_10+esp_IV_10,
         top_50_mat_10=mat_1II_10+mat_IV_10,
         top_25_esp_10=esp_IV_10,
         top_25_mat_10=mat_IV_10,
         bottom_50_esp_10=esp_1_10+esp_II_10,
         bottom_50_mat_10=mat_1_10+mat_II_10, #convierto a mi variable de interes (porcentaje de niños en la mejor mitad y mitad inferior)
         bottom_25_esp_10=esp_1_10,
         bottom_25_mat_10=mat_1_10)) #convierto a mi variable de interes (porcentaje de niños en la mejor mitad)
...
planeas_del_10_al_19$bottom_50_esp_19<-as.numeric(planeas_del_10_al_19$top_50_esp_19)
planeas_del_10_al_19$bottom_50_mat_19<-as.numeric(planeas_del_10_al_19$top_50_mat_19)
planeas_del_10_al_19$bottom_50_esp_10<-as.numeric(planeas_del_10_al_19$top_50_esp_10)
planeas_del_10_al_19$bottom_50_mat_10<-as.numeric(planeas_del_10_al_19$top_50_mat_10)

planeas_del_10_al_19$top_25_esp_10<-as.numeric(planeas_del_10_al_19$top_25_esp_10)
planeas_del_10_al_19$top_25_mat_10<-as.numeric(planeas_del_10_al_19$top_25_mat_10)

planeas_del_10_al_19$bottom_25_esp_19<-as.numeric(planeas_del_10_al_19$top_25_esp_19)
planeas_del_10_al_19$bottom_25_mat_19<-as.numeric(planeas_del_10_al_19$top_25_mat_19)
