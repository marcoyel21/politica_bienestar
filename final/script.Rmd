...
Por último, el nivel alto de desagregación de los datos de la prueba de Planea y del censo de la INEGI, que en su última versión proveyó por primera vez una base de Principales resultados por localidad, permite que se haga un *match* entre estas dos bases y se use el método cuasi-experimental de *propensity score matching* para 
