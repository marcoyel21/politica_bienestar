...
data %>% ggplot(aes(x=factor(cuadrantes),fill=factor(s_salud)))+geom_bar(position = "fill")+scale_y_continuous(name="%",labels=scales::percent)
data %>% ggplot(aes(x=factor(cuadrantes),fill=factor(jef_ss)))+geom_bar(position = "fill")+scale_y_continuous(name="%",labels=scales::percent)
data %>% ggplot(aes(x=factor(cuadrantes),fill=factor(ss_dir)))+geom_bar(position = "fill")+scale_y_continuous(name="%",labels=scales::percent)
data %>% ggplot(aes(x=factor(cuadrantes),fill=factor(tam_loc)))+geom_bar(position = "fill")+scale_y_continuous(name="%",labels=scales::percent)
