...
#3: Medio alto
#4: Alto
data<-data%>% select(folioviv,foliohog,est_socio,alimentos,leche,huevo,gasto_mon,pescado,tam_loc)%>%
  mutate(p_leche=18.72, q_leche=leche/18.72, p_huevos=28.5,q_huevos=huevo/28.5)
