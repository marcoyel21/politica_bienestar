...
Podemos notar que todos los parámetros del primer bien, o sea el huevo, son significativos, incluyendo a $\lambda$. No todos los parámetros de leche, sin embargo, son significativos: solo el de $\alfa$ lo es. Esto podría indicar que la proporción del gasto de este bien contra el ingreso es más bien lineal. 
